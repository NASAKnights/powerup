...
public class AutonomousCommand
{
    ...
    private final class Right_Scale_Auto extends CommandGroup
    {
        public Right_Scale_Auto()
        {
            ...
            addSequential(new ElevatorHeightCommand(ElevatorCommand.ElevatorHeight.TOP, false), 3);
            addSequential(new TurnDriveCommand(-.7, 225), .225);
            addSequential(new StraightDriveCommand(-.4, 500), 500);
            ...
            addSequential(new StraightDriveCommand(.4, 1500), 1.5);
        }
    }
